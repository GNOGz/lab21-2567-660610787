...
import { StrangeEnrollment } from "@lib/types";
...
export default function StudentPage() {
  const [myEnrollments, setMyEnrollments] = useState<StrangeEnrollment[] | null>(null);
  ...
  return (
    <Stack>
      ...
      <Paper withBorder p="md">
        ...
        {myEnrollments &&
          myEnrollments.map((enroll:StrangeEnrollment) => (
